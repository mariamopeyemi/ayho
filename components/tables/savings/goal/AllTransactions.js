...
import FailedReceiptModal from "../../../modal/saving/FailedReceiptModal";

const AllTransaction = () => {
  
  const [failedReceipt, setFailedReceipt] = useState(false);
  return (
    <div className=" bg-white p-[2.4rem] rounded-[1.2rem]">
      {/* { FailedReceipt Modal */}
      { failedReceipt && <FailedReceiptModal
        toggle={()=>setFailedReceipt(false)}
        open={()=>setFailedReceipt(true)} />}
        ...
        <table className=" w-full border-l border-gray-lighter border-collapse">
          ...
          <tbody className="text-[#666668] whitespace-nowrap !gap-8  ">
            ...
            <tr className="h-[52px] border-solid border border-gray-200 rounded-xl  px-[0.4rem]">
              ...
              <td className="px-[16px] text-left ">
                <p className="underline cursor-pointer text-[#137C4B]" onClick={setFailedReceipt}>View</p>
              </td>
            </tr>
            <tr className="h-[52px] border-solid border border-gray-200 rounded-xl  px-[0.4rem]">
              <td className="px-[16px] text-left ">
