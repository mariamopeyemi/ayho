...
const ViewTop = ({title, user, withBack, withTitle='true', withRed, greenBtnTitle='Pay', redBtnTitle='Remove', loading, redBtnClick, greenBtnClick, onReport, className}) => {
    ...
    <div className='flex flex-row justify-between '>
        <div className='flex flex-row text-center gap-[2rem] items-center w-[40%]'>
            ...
            <Image src='/images/useravatar.svg' alt='avatar' width='35px' height='35px' />
            ...
            <div className='flex flex-row text-center gap-[1rem] items-center'>
                ...
                <Image src='/images/redflag.svg' alt='avatar' width='15px' height='15px' />
                <p className=' text-[#C31331] underline cursor-pointer' onClick={onReport} >Report</p>
            </div>
        </div>  
